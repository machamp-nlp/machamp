...
class DependencyDecoder(Model):
    ...
    def __init__(self,
        ...
        # todo: fix it, to ignore puctuation
    ...
    def forward(self,  # type: ignore
                ...
                prev_task_classes: torch.LongTensor = None,  # predicted # A: pos_logits is treated as prev_task_logits
        ...
        if head_indices is not None and head_tags is not None:
            ...
            arc_nll, tag_nll = self._construct_loss(head_tag_representation=head_tag_representation,
                                                    ...
                                                    mask=mask)
            loss = self.loss_weight * (arc_nll + tag_nll)
