...
@TokenEmbedder.register("machamp_character_encoding")
class MachampTokenCharactersEncoder(TokenEmbedder):
    """
    ...
    def __init__(self, embedding: Embedding, encoder: Seq2VecEncoder, dropout: float = 0.0) -> None:
        super(MachampTokenCharactersEncoder, self).__init__()
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'UDTokenCharactersEncoder':  # type: ignore
