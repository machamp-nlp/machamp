# Borrowed from allennlp, to avoid having to install the whole allennlp library
import logging
...
class ScalarMix(torch.nn.Module):
    ...
    def __init__(
        ...
        # Edited here, because a ModuleDict of ParameterList of Parameters is not possible in torch?
