...
def decode_mst(
    ...
    if has_labels and energy.ndim != 3:
        logger.error("The dimension of the energy array is not equal to 3.")
        exit(1)
    elif not has_labels and energy.ndim != 2:
        logger.error("The dimension of the energy array is not equal to 2.")
        exit(1)
...
def chu_liu_edmonds(
    ...
    if not has_cycle:
        ...
        for node in range(1, length):
            ...
            # Rob: Added this to fix double roots
