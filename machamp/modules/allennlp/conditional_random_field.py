...
def allowed_transitions(constraint_type: str, labels: List[str]) -> List[Tuple[int, int]]:
    """
    ...
    labels_with_boundaries = [(label_idx, label) for label_idx, label in enumerate(labels)] + [(start_tag, "START"),
                                                                                               (end_tag, "END")]
