...
@TextFieldEmbedder.register("machamp_embedder")
class MachampTextFieldEmbedder(TextFieldEmbedder):
    """
    ...
    def __init__(self,
        ...
        super(MachampTextFieldEmbedder, self).__init__()
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'MachampTextFieldEmbedder':  # type: ignore
