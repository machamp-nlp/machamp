...
@Metric.register("fbeta-fixedMacro")
class FBetaMeasure(Metric):
    ...
    def get_metric(self, reset: bool = False):
        ...
        if self._average == "macro":
            precision = precision[2:].mean() # skip unknown and padding
            recall = recall[2:].mean() # skip unknown and padding
            fscore = fscore[2:].mean() # skip unknown and padding
